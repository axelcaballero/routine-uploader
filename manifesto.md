...
* El total de series debe de ser las indicadas y además sumando la serie de calentamiento. Es decir, si la rutina dice 4 x 12, son 5 series ( 1 tipo “warmup”, 4 tipo “normal”)
* La duracion predeterminada del tiempo de recuperacion es de 1 minuto para todos los ejercicios.
